...
import IslandMap from '@/app/components/games/island-map';
...
const classData = [
  {
    ...
    markers: [
      { id: "m1", x: 500, y: 450, active: true },
      { id: "m2", x: 420, y: 370, active: false },
      { id: "m3", x: 350, y: 300, active: false },
    ],
  },
  {
    id: "2",
    ...
    markers: [
      { id: "m1", x: 300, y: 420, active: true },
      { id: "m2", x: 250, y: 320, active: false },
      { id: "m3", x: 350, y: 320, active: false },
    ],
  },
  {
    id: "3",
    ...
    markers: [
      { id: "m1", x: 200, y: 200, active: true },
      { id: "m2", x: 250, y: 160, active: false },
      { id: "m3", x: 300, y: 180, active: false },
    ],
  },
  {
    id: "4",
    ...
    markers: [
      { id: "m1", x: 255, y: 440, active: true },
      { id: "m2", x: 250, y: 200, active: false },
      { id: "m3", x: 200, y: 250, active: false },
    ],
  },
  {
    id: "5",
    ...
    markers: [
      { id: "m1", x: 150, y: 200, active: true },
      { id: "m2", x: 250, y: 250, active: false },
      { id: "m3", x: 350, y: 300, active: false },
    ],
  },
];
...
export default function ClassDetailPage() {
  ...
  useEffect(() => {
    ...
    let classId = params.id as string;
    ...
    if (currentClass) {
      ...
      // If class not found, set default to the first class
  ...
  const handleStartLearning = () => {
    ...
    router.push({
      pathname: "/(games)/activities/[id]/page",
      params: { id: classInfo.id }
    });
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.mapContainer}>
        ...
        <IslandMap classId={classInfo.id} markers={classInfo.markers} />
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.progressContainer}>
            <View style={styles.progressItem}>
              <CircleProgress percentage={classInfo.progress.reading} color="#4CAF50" />
              <Text style={styles.progressLabel}>{classInfo.progress.reading}%</Text>
            </View>
            <View style={styles.progressItem}>
              <CircleProgress percentage={classInfo.progress.writing} color="#FFC107" />
